...
const colors = [
  0xff0000, 0xff9a00, 0xffec00, 0xbeff00, 0x00c200, 0x65ffff, 0x3875db,
  0xf21eec, 0xe4bcff, 0xf21eec,
]

export async function sendAssignment(assignment: Assignment): Promise<void> {
  const bookPages = await getPages(
    assignment.range.start,
    assignment.range.stop
  )
